...
public final class Rules {
    ...
    public static final int IS_NUMBER_LOWER_THAN = 8;
    public static final int IS_NUMBER_GREATER_THAN = 9;
    ...
    public final boolean isNumberLowerThan(String value) {
        return Integer.parseInt(value) < this.limit;
    }

    public final boolean isNumberGreaterThan(String value) {
        return Integer.parseInt(value) > this.limit;
    }
    ...
    public boolean validateRule(String value) {
        return switch (this.currentRule) {
            ...
            case Rules.IS_MIN ->
                this.min(value);
            case Rules.IS_PHONE_NUMBER ->
                this.isPhoneNumber(value);
            case Rules.IS_EMAIL ->
                this.isEmail(value);
            case Rules.IS_PASSWORD_CONFIRM ->
                this.isPasswordConfirm(value, this.confirmValue);
            case Rules.IS_CONTAINS_WHITE_SPACE ->
                this.isContainWhiteSpace(value);
            case Rules.IS_NUMBER_LOWER_THAN ->
                this.isNumberLowerThan(value);
            case Rules.IS_NUMBER_GREATER_THAN ->
                this.isNumberGreaterThan(value);
            default ->
                false;
        };
    }
